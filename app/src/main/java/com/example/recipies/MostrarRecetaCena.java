...
public class MostrarRecetaCena extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptadorIngredientes = new adaptadorIngredientesMostrar(MostrarRecetaCena.this, ingredientesDataList);
        adaptadorPasos = new adaptadorPasosMostrar(MostrarRecetaCena.this, pasosDataList);
        ...
        ingredientesRecyclerView.setLayoutManager(new LinearLayoutManager(MostrarRecetaCena.this));

        // Configura RecyclerView para Pasos
        pasosRecyclerView.setAdapter(adaptadorPasos);
        pasosRecyclerView.setLayoutManager(new LinearLayoutManager(MostrarRecetaCena.this));
        ...
        Btnempezar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MostrarRecetaCena.this);
                ...
                builder.setMessage("¿Está seguro de querer terminar esta receta?")
                        .setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int i) {
                                ...
                                pasosRecyclerView.setVisibility(View.GONE);
                                float caloriasCena = Float.parseFloat(caloriasTextView.getText().toString());
                                ...
                                edit.putString("recetaPreparadaCena" + perfil, String.valueOf(tituloTextView));
                                edit.apply();

                                // Guardar valor
                                SharedPreferences prefs = getSharedPreferences("CaloriasRestantes" + perfil, MODE_PRIVATE);
                                SharedPreferences.Editor editor = prefs.edit();
                                editor.putFloat("caloriasCena", caloriasCena);
                                editor.apply();
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            if (document.exists()) {
                                                ...
                                                data.put("cenaCalorias", caloriasCena);
                                                data.put("cenaHora", formattedHora);
                                                ...
                                                documentReference.update(data).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(MostrarRecetaCena.this, "Progreso No guardado", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            } else {
                                                // El documento no existe, créalo
                                                Map<String, Object> newData = new HashMap<>();
                                                newData.put("cenaCalorias", caloriasCena);
                                                newData.put("cenaHora", formattedHora);
                                            ...
                                            Toast.makeText(MostrarRecetaCena.this, "Error al verificar existencia del documento", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
    ...
    private void checkAndShowStartButton() {
        SharedPreferences prefs = getSharedPreferences("EmpezarRecetaCena" + perfil, MODE_PRIVATE);
