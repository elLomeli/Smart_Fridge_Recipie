...
public class MostrarRecetaComida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptadorIngredientes = new adaptadorIngredientesMostrar(MostrarRecetaComida.this, ingredientesDataList);
        adaptadorPasos = new adaptadorPasosMostrar(MostrarRecetaComida.this, pasosDataList);

        // Configura RecyclerView para Ingredientes
        ingredientesRecyclerView.setAdapter(adaptadorIngredientes);
        ingredientesRecyclerView.setLayoutManager(new LinearLayoutManager(MostrarRecetaComida.this));

        // Configura RecyclerView para Pasos
        pasosRecyclerView.setAdapter(adaptadorPasos);
        pasosRecyclerView.setLayoutManager(new LinearLayoutManager(MostrarRecetaComida.this));
        ...
        Btnempezar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MostrarRecetaComida.this);
                ...
                builder.setMessage("¿Está seguro de querer terminar esta receta?")
                        .setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int i) {
                                ...
                                pasosRecyclerView.setVisibility(View.GONE);
                                float caloriasComida = Float.parseFloat(caloriasTextView.getText().toString());
                                ...
                                edit.putString("recetaPreparadaComida" + perfil, id); // Guarda el ID de la receta
                                edit.apply();

                                // Guardar valor
                                SharedPreferences prefs = getSharedPreferences("CaloriasRestantes" + perfil, MODE_PRIVATE);
                                SharedPreferences.Editor editor = prefs.edit();
                                editor.putFloat("caloriasComida", caloriasComida);
                                editor.apply();
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            if (document.exists()) {
                                                ...
                                                data.put("comidaCalorias", caloriasComida);
                                                data.put("comidaHora", formattedHora);
                                                ...
                                                documentReference.update(data).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(MostrarRecetaComida.this, "Progreso No guardado", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            } else {
                                                // El documento no existe, créalo
                                                Map<String, Object> newData = new HashMap<>();
                                                newData.put("comidaCalorias", caloriasComida);
                                                newData.put("comidaHora", formattedHora);
                                            ...
                                            Toast.makeText(MostrarRecetaComida.this, "Error al verificar existencia del documento", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
    ...
    private void checkAndShowStartButton() {
        SharedPreferences prefs = getSharedPreferences("EmpezarRecetaComida" + perfil, MODE_PRIVATE);
