...
public class ImageCheckerProducts {
    ...
    private void checkImages() {
        ...
        StorageReference imagesRef = storageRef.child("imagesProducts");
    ...
    private String getImageNameFromUrl(String imageUrl) {
        int startIndex = imageUrl.indexOf("imagesProducts%2F") + 17;
