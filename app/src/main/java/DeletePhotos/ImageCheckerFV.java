...
public class ImageCheckerFV {
    ...
    private void checkImages() {
        ...
        StorageReference imagesRef = storageRef.child("imagesFV");
    ...
    private void getListOfImages(StorageReference reference) {
        reference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                checkImagesWithFirestoreFV(imageReferences);
            }
    ...
    private void checkImagesWithFirestoreFV(List<StorageReference> imageReferences) {
    ...
    private String getImageNameFromUrl(String imageUrl) {
        int startIndex = imageUrl.indexOf("imagesFV%2F") + 11;
