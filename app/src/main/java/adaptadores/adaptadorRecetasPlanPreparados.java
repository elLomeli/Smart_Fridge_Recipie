...
public class adaptadorRecetasPlanPreparados extends RecyclerView.Adapter<adaptadorRecetasPlanPreparados.MyviewHolder> {
    ...
    public adaptadorRecetasPlanPreparados(Context context, ArrayList<RecetasPlan> recetasPlanArrayList, String perfilId) {
    ...
    private void updateBackgroundAndListener(MyviewHolder holder, RecetasPlan recetasPlan) {
