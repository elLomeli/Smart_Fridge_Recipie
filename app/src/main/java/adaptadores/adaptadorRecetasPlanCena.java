...
import com.example.recipies.MostrarRecetaCena;
...
public class adaptadorRecetasPlanCena extends RecyclerView.Adapter< adaptadorRecetasPlanCena.MyviewHolder> {
    ...
    public adaptadorRecetasPlanCena(Context context, ArrayList<RecetasPlan> recetasPlanArrayList, String perfilId) {
    ...
    @NonNull
    @Override
    public adaptadorRecetasPlanCena.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull adaptadorRecetasPlanCena.MyviewHolder holder, int position) {
    ...
    private void updateBackgroundAndListener(adaptadorRecetasPlanCena.MyviewHolder holder, RecetasPlan recetasPlan) {
            ...
            holder.receta.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        Intent intent = new Intent(context, MostrarRecetaCena.class);
