...
import com.example.recipies.MostrarRecetaDesayuno;
...
public class adaptadorRecetasPlanDesayuno extends RecyclerView.Adapter< adaptadorRecetasPlanDesayuno.MyviewHolder> {
    ...
    public adaptadorRecetasPlanDesayuno(Context context, ArrayList<RecetasPlan> recetasPlanArrayList, String perfilId) {
    ...
    @NonNull
    @Override
    public adaptadorRecetasPlanDesayuno.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull adaptadorRecetasPlanDesayuno.MyviewHolder holder, int position) {
    ...
    private void updateBackgroundAndListener(adaptadorRecetasPlanDesayuno.MyviewHolder holder, RecetasPlan recetasPlan) {
            ...
            holder.receta.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        Intent intent = new Intent(context, MostrarRecetaDesayuno.class);
